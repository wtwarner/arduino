...
const int NOTE_PER_OCTAVE = 12;
const std::array<float, NOTE_PER_OCTAVE*9> note_freq {
...
float find_note(float freq, const char *&name, int &octave)
{
    auto iter = std::upper_bound(note_freq.begin(), note_freq.end(), freq);
